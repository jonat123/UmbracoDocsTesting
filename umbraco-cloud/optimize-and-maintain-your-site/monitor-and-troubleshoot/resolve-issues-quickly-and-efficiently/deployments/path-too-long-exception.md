...
1. Connect to your Live environments [database](../../../../build-and-customize-your-solution/set-up-your-project/databases/cloud-database/local-database.md#connecting-to-your-local-umbraco-installation).
